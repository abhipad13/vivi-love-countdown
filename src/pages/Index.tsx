    ...
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <header className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-romantic-blush via-romantic-pink to-romantic-rose">
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className={`font-romantic text-6xl md:text-8xl text-white mb-8 drop-shadow-lg ${showContent ? 'animate-fade-in-up' : 'opacity-0'}`}>
            Happy Girlfriend's Day, Vivi ❤️
          </h1>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="sparkle" style={{ top: '30%', right: '15%', animationDelay: '1s' }}></div>
          <div className="sparkle" style={{ bottom: '40%', left: '20%', animationDelay: '2s' }}></div>
          <div className="sparkle" style={{ bottom: '20%', right: '25%', animationDelay: '0.5s' }}></div>
          <div className="sparkle" style={{ top: '50%', left: '50%', animationDelay: '1.5s' }}></div>
        </div>
      </header>
