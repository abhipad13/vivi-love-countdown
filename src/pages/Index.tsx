  ...
  return <div className="min-h-screen relative overflow-x-hidden">
      ...
      <header className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-romantic-blush via-romantic-pink to-romantic-rose">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className={`font-elegant text-xl md:text-2xl text-white/90 max-w-2xl mx-auto leading-relaxed drop-shadow ${showContent ? 'animate-fade-in-up animate-delay-1' : 'opacity-0'}`}>I love you so much, my duniya — my whole world, my everything. You mean more to me than words can ever captur.</p>
        </div>
